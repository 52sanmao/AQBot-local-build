...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SettingsSidebarItemConfig {
    pub id: String,
    pub visible: bool,
}
...
pub struct AppSettings {
    ...
    pub settings_sidebar_items: Vec<SettingsSidebarItemConfig>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            settings_sidebar_items: vec![
                SettingsSidebarItemConfig { id: "general".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "display".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "providers".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "conversationSettings".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "defaultModel".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "searchProviders".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "mcpServers".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "proxy".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "shortcuts".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "data".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "storage".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "backup".to_string(), visible: true },
                SettingsSidebarItemConfig { id: "about".to_string(), visible: true },
            ],
            titlebar_quick_actions: vec![
                TitlebarQuickActionConfig { id: "pin".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "theme".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "language".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "backup".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "github".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "update".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "reload".to_string(), visible: true },
                TitlebarQuickActionConfig { id: "settings".to_string(), visible: true },
            ],
        }
    }
}
